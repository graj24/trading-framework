...
# Indicators (RSI, MACD, EMA, ATR, ADX, Bollinger, OBV, VWAP) live in
# core/features.py — see Stage 0 measurement scaffolding. Only the
# repository-specific structure detector below stays local.
