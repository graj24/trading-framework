...
# CLI:
curl -X POST 'http://<TRADING_EC2_IP>/api/pms/1/pause?reason=manual%20review'
curl -X POST 'http://<TRADING_EC2_IP>/api/pms/1/resume'
curl 'http://<TRADING_EC2_IP>/api/pms/1/paused'
```
...
# CLI:
curl 'http://<TRADING_EC2_IP>/api/pms/kill_switch'
curl -X POST 'http://<TRADING_EC2_IP>/api/pms/kill_switch/activate'
curl -X POST 'http://<TRADING_EC2_IP>/api/pms/kill_switch/deactivate'
```
